...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.Todo6";
    ...
    public void viewSecondActivity(View view) {
        ...
        Intent intent = new Intent(this, com.example.Todo6.MainActivity2.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == TEXT_REQUEST){
            if(resultCode == RESULT_OK){
                String Reply = data.getStringExtra(com.example.Todo6.MainActivity2.EXTRA_REPLY);
                textView.setVisibility(View.VISIBLE);
